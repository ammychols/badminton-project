          ...
          <div className="flex gap-2 items-center">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="ค้นหา"
                className="w-full py-2 pl-9 pr-3 text-sm leading-none bg-white border border-[var(--input-b)] rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--input-f)] placeholder-[var(--dashed)]"
              />
              {search && (
            ...
            <select
              ...
              className="flex-shrink-0 py-2 px-3 text-sm leading-none font-medium rounded-xl border focus:outline-none focus:ring-2 focus:ring-[var(--input-f)]"
